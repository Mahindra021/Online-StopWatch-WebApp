  ...
  return (
    ...
    <div className='flex place-content-between m-1 p-3'>
        ...
        <ul className='flex gap-5 text-[23px] pr-5 font-bold tabular-nums'>
            <li className='place-content-center p-1 hover:bg-slate-300 rounded-md hover:border-black border-transparent border-2 transition duration-300 ease-in-out'>
